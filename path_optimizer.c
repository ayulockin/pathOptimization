...
This code takes a hardcoded sequence

of path taken to reach the destination.

The code gives the optimized path by

replacing all non desired turns to reach

the destination ie, end of maze.
